...
def image_processed(file_path, hands):
    ...
    if output.multi_hand_landmarks:
        ...
        for data in output.multi_hand_landmarks:
...
def make_csv(hands):
    ...
    TODO: frame notation of the dataset can be optimized by calling mediapipe hands only once at 
        ...
        if '._' in each_folder:
            ...
            for each_number in os.listdir(mypath + '/' + each_folder):
                if '._' in each_number:
                    ...
                    data = image_processed(file_loc, hands)
                    try:
